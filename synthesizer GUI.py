...
#============================Label with title =====================
Label(ABC1, text="Piano",font=('arial',25,'bold'),padx=8,pady=8,bd=4,bg="powder blue",
...
btnSpace=Button(ABC2, state=DISABLED, width=2,height=6 ,bg = "powder blue",relief=FLAT)
